...
public class YourFridgeActivity extends DrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int sizeOfFridgeProducts = DatabaseHelper.getInstance(YourFridgeActivity.this).getUserShoppingList(DatabaseHelper.getInstance(YourFridgeActivity.this).getCurrentUser().getFacebookID()).size();
